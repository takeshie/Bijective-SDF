...
We support both raw point clouds and mesh-sampled point clouds as inputs. Place the point cloud or mesh files in the /data directory. To sample point clouds at different scales, modify the preenc_npoints parameter in the configuration file.
