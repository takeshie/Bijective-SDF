...
def spherical_to_cartesian(spherical_angles):
    r = 1.0

    # Unpack azimuthal and polar angles
    theta = spherical_angles[..., 0]
    phi = spherical_angles[..., 1]

    # Calculate cartesian coordinates using the fixed radius
